    ...
    <div style="border:solid 2px #D9DCE0;background-color:#F5F5F5">
      <form id="form1" runat="server" class="form-horizontal" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6">
             <input type='file'  id="imginp" class="form-control" style="" name="imginp" value="<?php echo URL::to(substr($artikel->gambar,6)); ?>" />
            <input type='hidden' class="form-control" style="" name="img_temp" value="{{$artikel->gambar }}" />           
          </div>
        </div>
       <div class="form-group">
          <div class="col-md-6">
            <label class="col-md-4 control-label"></label>
            <img id="blah" src="<?php echo URL::to(substr($artikel->gambar,6)); ?>" style="margin-left:2%;width:30%" />
            </div>
       </div>
       <div class="form-group">
          <div class="col-md-11" style="margin-left:4%">
            <textarea id="summernote" name="konten">{{ $artikel->konten }}</textarea>
          </div>
        </div>
        <div class="form-group">
