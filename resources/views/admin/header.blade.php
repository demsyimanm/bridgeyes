  <head>
	...
	<!-- Morris chart -->
	<link rel="stylesheet" href="{{ URL::to('assets/AdminLTE/plugins/morris/morris.css')}}">
	<!-- jvectormap -->
...
<!-- jQuery -->
	...
	<script type="text/javascript" charset="utf8" src="{{ URL::to('assets/js/jquery-1.11.3.min.js') }}"></script>
...
<!-- DataTables -->
    ...
    <script src="{{ URL::to('assets/plugin/summernote/dist/summernote.min.js') }}"></script>
  <style>
      .example-modal .modal {
        position: relative;
        top: auto;
